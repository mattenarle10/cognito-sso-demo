    ...
    <AuthCard>
      ...
      <div class="mb-4 relative text-center">
        ...
        <h1 class="text-3xl font-bold tracking-tight mb-1 relative">
          <span class="bg-gradient-to-r from-gray-200 via-gray-100 to-gray-300 bg-clip-text text-transparent relative inline-block">Verify Your Email</span>
        </h1>
...
// Computed property to combine all digits into a single OTP code
